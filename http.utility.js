...
var HttpUtility = /** @class */ (function () {
    function HttpUtility() {
        ...
        try {
            ...
            this._APPMAIL = process.env.JENNYSYS_USERNAME || "";
            console.log("JennySysSDK is initialized to host : " + this._HOST);
        }
        catch (ex) {
            console.log(ex);
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("JennySYSSDK doPost (params) : " + JSON.stringify(params));
                    ...
                    case 1:
                        ...
                        console.log("[JennySysSDK] url ==> " + this._HOST + url);
